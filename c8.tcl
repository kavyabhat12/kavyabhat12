...
set group [Node allocaddr] ;#allocate multicast adress
...
$udp set dst_addr_ $group #group contain all address
$udp set dst_port_ 0  #assigning port number

set rcvr1 [new Agent/LossMonitor] ;#create a receiver agent at node 1
$ns attach-agent $n1 $rcvr1
$ns at 1.9 "$n1 join-group $rcvr1 $group" ;#join the group at simulation time 1.9sec
